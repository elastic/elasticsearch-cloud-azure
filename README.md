...
|-----------------------------|---------------------|:------------:|
| 2.1.1-SNAPSHOT              | 1.0.0 -> 1.0        |  XXXX-XX-XX  |
| 2.1.0                       | 1.0.0 -> 1.0        |  2014-03-17  |
| 2.0.0                       | 1.0.0 -> 1.0        |  2014-02-14  |

Please read documentation relative to the version you are using:

* [2.1.1-SNAPSHOT](https://github.com/elasticsearch/elasticsearch-cloud-azure/blob/es-1.0/README.md)
* [2.1.0](https://github.com/elasticsearch/elasticsearch-cloud-azure/blob/v2.1.0/README.md)
