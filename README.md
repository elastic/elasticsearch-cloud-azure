...
|-----------------------------|---------------------|:------------:|
| 1.0.0-SNAPSHOT              | 0.90.6 -> 0.90      |  XXXX-XX-XX  |
| 1.0.0.alpha1                | 0.90.6 -> 0.90      |  2013-11-06  |

Please read documentation relative to the version you are using:

* [1.0.0-SNAPSHOT](https://github.com/elasticsearch/elasticsearch-cloud-azure/blob/es-0.90/README.md)
* [1.0.0.alpha1](https://github.com/elasticsearch/elasticsearch-cloud-azure/blob/v1.0.0.alpha1/README.md)
